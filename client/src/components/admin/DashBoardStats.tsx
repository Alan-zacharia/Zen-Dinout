  ...
  return (
    <div className="md:flex md:flex-col lg:flex-row grid grid-cols-2  gap-4 w-auto">
      ...
      <BoxWrapper>
        ...
        <div className="pl-4">
          <span className="text-sm text-gray-500 font-bold">Total Restaurants</span>
          <div className="flex items-center">
      ...
      <BoxWrapper>
        ...
        <div className="pl-4">
          ...
          <div className="flex items-center">
            <strong className="text-lg text-gray-700 font-bold">100</strong>
            <span className="text-sm text-red-400 pl-2 font-bold">- 20</span>
          </div>
        </div>
      </BoxWrapper>
