...
const Footer : React.FC = () => {
  ...
  <nav >
    ...
    <a className="link link-hover text-gray-400">Cancellation Policy</a>
  ...
  <nav >
    ...
    <a className="link link-hover text-gray-400">Booking status</a>
    <a className="link link-hover text-gray-400">Add Restaurant</a>
  </nav> 
