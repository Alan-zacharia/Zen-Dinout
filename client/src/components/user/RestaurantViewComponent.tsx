...
const RestaurantViewComponent = () => {
  ...
  return (
       <div className="m-auto h-[1000px] w-[1240px] flex gap-10">
          <div className="h-full w-[900px] bg-red-500 flex flex-col">
          <div >
            <img src={restaurantDetails?.featuredImage} alt=""  />\
          ...
          <div className="h-[600px] w-[380px] bg-green-500">
