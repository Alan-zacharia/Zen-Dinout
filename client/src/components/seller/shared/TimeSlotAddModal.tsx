...
const TimeSlotAddModal : React.FC<TimeSlotAddModalProps> = ({addTimeSlot , timeSlots}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      setIsLoading(true);
      axiosInstance
        .post("/restaurant/add-time-slot", { data })
        .then((response) => {
                ...
                <div className="flex flex-col gap-4 mt-7">
                  <div className="flex flex-row gap-5  pb-5">
                    <div>
                      ...
                      />
                       {formik.errors.startTime && formik.submitCount > 0 && formik.touched.startTime && (
                    ...
                    <div>
                      ...
                      />
                      {formik.errors.endTime && formik.submitCount > 0 && formik.touched.endTime && (
                        <div className="text-red-500 font-bold text-sm">
